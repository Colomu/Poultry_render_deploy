...
def formulate():
    ...
    # Validate inputs
    if not poultry_class or poultry_class not in nutrient_requirements:
        return jsonify({'error': 'Invalid or missing poultry class. Please select a valid class.'})
    ...
    # Fetch nutrient requirements for the selected poultry class
    requirements = nutrient_requirements[poultry_class]
